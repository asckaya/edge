// Mihomo/Stash White (White-list mode) routing rules.
// White-list mode: Specified domestic rules Direct/CN, Everything else Proxy.

export const configMihomoWhiteRules = `rules:
  # 广告拦截
  ...
  # 国内直连 (White-list: CN services go 🔒 国内服务)
