...
export const ConfigTypeSchema = z.enum(['mihomo', 'mihomo-mini', 'mihomo-micro', 'mihomo-dual', 'stash', 'stash-mini', 'stash-micro', 'stash-dual', 'sing-box', 'sing-box-mini', 'sing-box-micro', 'sing-box-dual']);
